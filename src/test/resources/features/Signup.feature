...
Feature: Signup
  ...
  @SignupWithoutFirstName @error @Green @Purple @Production
  ...
  @SignupWithoutLastName @error @Green @Purple @Production
  ...
  @SignupWithoutEmail @error @Green @Purple @Production
