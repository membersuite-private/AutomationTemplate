...
public class CommunityPage{
    ...
    public SelenideElement typeBOnCommitteeTypes = $(By.xpath("(//*[contains(text(),'Type B')])[1]"));
    public SelenideElement committeeTwoOnBrowseAllCommittees = $(By.xpath("(//*[contains(text(),'Committee Two')])[1]"));
    ...
    public SelenideElement discussionBoardTextOnDiscussions = $(By.xpath("(//*[contains(text(),'Kelly Gills PRD D')])[1]"));
    ...
    public SelenideElement forumOneNotMembersOnDiscussionBoard = $(By.xpath("(//*[contains(text(),'Forum 1 - not')])[1]"));
    public SelenideElement musicStreamingOnForumOne = $(By.xpath("(//*[contains(text(),'Music Streaming')])[1]"));
    public SelenideElement oneoftheforumOnTopicSubscriptions = $(By.xpath("(//*[contains(text(),'115pm')])[1]"));
    ...
    public SelenideElement orgDotCom1049ApplyJob = $(By.xpath("(//*[contains(text(),'1049 pm')])[1]"));
    public SelenideElement applyNow1049OnCareerCenterJobPost = $(By.xpath("(//*[contains(text(),'Apply Now')])[1]"));
    public SelenideElement applyOnApplyNowOnCareerCenter = $(By.xpath("(//button[contains(text(),'Apply')])[3]"));
    ...
    public SelenideElement fancyCompetitionOnBrowseCompetition = $(By.xpath("(//*[contains(text(),' Fancy new competition ')])[1]"));
    ...
    public SelenideElement entryType1OnEntryTypeEntryFee = $(By.xpath("(//*[contains(text(),' Competition Entry Type 1 ')])[1]"));
    public SelenideElement nextOnEntryFee = $(By.xpath("(//*[contains(text(),'Next')])[1]"));
    public SelenideElement nameOnEntryForm = $(By.xpath("mat-input-0"));
    public SelenideElement whatColorSocksOnEntry = $(By.xpath("mat-input-7"));
    public SelenideElement enterTheAlphateOnEntryFee = $(By.xpath("mat-input-8"));
    ...
    public SelenideElement viewFirstOnMyCompetitionEntriesOnCompetitions = $(By.xpath("(//*[contains(text(),'View')])[2]"));
