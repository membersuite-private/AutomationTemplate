...
public class BasePage {
    ...
    @FindBy(xpath = "//*[@id='Evercast_Lockup']")
    public WebElement evercastLogo;

    @FindBy(xpath = "//*[@class='card-title']")
    public WebElement evercastWelcome;
    ...
    public boolean waitUntilLoaderMaskDisappear() {
        ...
        try {
            wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='Evercast_Lockup']")));
            return true;
